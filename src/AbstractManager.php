...
use Cline\Manager\Exceptions\DefaultConnectionMustBeStringException;
...
abstract class AbstractManager implements ManagerInterface
{
     ...
     *
     * @throws DefaultConnectionMustBeStringException When the default connection is not configured as a string
     *
    ...
    public function getDefaultConnection(): string
    {
        ...
        if (!is_string($default)) {
            throw DefaultConnectionMustBeStringException::create();
        }
